window.onload = function () {
    ...
    var gameOver = false;
        var level = 1,i=0,timer = 1500,time;

        var score = localStorage.getItem("myscore1");
        score = Number(score);
        ...
        object.player.src = "assets/hero2.png";
        ...
        object.goal.src = "assets/home.gif";
            ...
            object.enemy[0].src = "assets/animal21.gif";
            object.enemy[1] = new Image();
            object.enemy[1].src = "assets/animal22.gif";
            object.enemy[2] = new Image();
            object.enemy[2].src = "assets/animal23.gif";
            object.enemy[3] = new Image();
            object.enemy[3].src = "assets/animal24.gif";
            object.enemy[4] = new Image();
            object.enemy[4].src = "assets/animal25.gif";
        ...
        function colliding(r1,r2){         //one life is completed angain start life 2
        ...
        var draw = function() {
            ...
            // giving box border ang blue background color
            //score board
        ...
        var render =  function () {
            ...
            localStorage.setItem("myscore2",score);
